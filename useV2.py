...
with open('/content/vihsd/tokenizer/tokenizer.pickle', 'rb') as handle:  # Mở tệp chứa tokenizer đã lưu
    tokenizer = pickle.load(handle)  # Tải tokenizer từ tệp

model = load_model('/content/drive/MyDrive/Colab Notebooks/BTLTUYEN/V3.Text_CNN_model_len150_e60_filter64.h5')  # Tải mô hình đã huấn luyện từ tệp

sequence_length = 150  # Độ dài chuỗi đã sử dụng trong quá trình huấn luyện
...
# ------------------ Example Usage ------------------ #
input_text = "đẹp  dm  m là nhất    đẹp"  # Văn bản đầu vào mẫu
